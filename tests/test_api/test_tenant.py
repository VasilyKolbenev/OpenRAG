...
from openrag.dependencies import AuthService
from openrag.middleware.tenant import TenantMiddleware, get_tenant_id
from openrag.models.tenant import Tenant
from openrag.models.base import TenantMixin
...
class TestTenantMiddleware:
    ...
    def test_extract_tenant_id_no_header(self):
        ...
        with patch("openrag.middleware.tenant.settings") as mock_settings:
