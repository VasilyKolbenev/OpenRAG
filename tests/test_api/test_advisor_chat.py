...
from openrag.api.v1.advisor import _extract_recommendation
...
class TestAdvisorChat:
    ...
    async def test_new_session_creates_id(
        ...
        with patch("openrag.api.v1.advisor.litellm") as mock_litellm:
            mock_response = MagicMock()
            mock_response.choices = [
                MagicMock(message=MagicMock(content="Hello! I'm OpenRAG Advisor. What domain?"))
            ]
