...
from openrag.tools.graph_store import GraphEdge, GraphNode, Neo4jService
from openrag.engine.llm import LLMService
from openrag.tools.tracing import TracingService
from openrag.tools.vector_store import QdrantService, SearchResult
...
def test_settings() -> Settings:
    ...
    return Settings(
        ...
        environment="testing",
        upload_dir="/tmp/openrag-test-uploads",
