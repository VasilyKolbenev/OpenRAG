...
ADVISOR_SYSTEM_PROMPT = """You are OpenRAG Advisor, a friendly and knowledgeable AI advisor for the \
OpenRAG platform. Your role is to help users choose the best RAG strategy and configuration \
